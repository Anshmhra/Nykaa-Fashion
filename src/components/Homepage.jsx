  ...
  try {
    ...
    return(
        <div className="ml-1 lg:ml-1">
                ...
                className="w-[358px] h-[93px] ml-3 rounded-2xl mt-4 lg:hover:cursor-pointer lg:hover:scale-95 lg:duration-300  lg:w-320 lg:ml-8 lg:h-63"
                /></div>
           ...
           <div onClick={()=>handleImageClick(57205,`/rendring?categoryId=57205`)}><img src="https://images-static.nykaa.com/uploads/dc45b5f1-8b81-452d-9b9a-33434377dc61.jpg?tr=w-300,cm-pad_resize"
            ...
            <div className="ml-8 mt-8 flex-shrink-0 w-[348px] h-[200px] lg:w-[1248px] lg:h-[650px] lg:ml-[18px] overflow-x-auto scrollbar-hide -mr-50  hover:cursor-pointer ">
            <div className="flex ">
             ...
             <div className="flex">
                ...
                /></div>
                 ...
                 <div className=" text-[14px] ml-4 lg:ml-15 mt-5 lg:text-[17px] ">
                <p className="font-semibold text-gray-500">IN THE SPOTLIGHT</p>
                <p className=" text-[16px] lg:text-2xl  font-semibold">Hottest brands on offer</p>
                </div>
  ...
  {[
    ...
    >
      <img
        src={card.img}
        alt={card.desc}
        className="w-36 ml-4 h-45 lg:h-72 lg:w-[220px] lg:-ml-1"
      />
      <div className="mb-5 ml-4 lg:-ml-1">
