            ...
            <div className="flex ">
             ...
             <div className="flex">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-5 gap-1  gap-x-1 ml-2 lg:ml-[56px] mt-7 mr-2 lg:mr-8 ">
                    <div onClick={()=>handleImageClick(4495,`/rendring?categoryId=4495`) } className="inline-block cursor-pointer relative z-10" ><img src="https://images-static.nykaa.com/uploads/4ee71bd4-d592-4667-8a93-821f1bc21e0c.jpg?tr=w-240,cm-pad_resize"
